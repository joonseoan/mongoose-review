...
// In mogoDB, the reson building schema 
//  is because of just need of basic structure of database.
//  and therefore because of taking advantage of the structure
//  to use 'mongoose.' Please, remember, in the pure mondoDB, 
//  we did not use schema.  
const prodcutSchema = new Schema({
    
    // we can use both ways below.

    // more flexible : getting schemaless
    // title: String
    
    // more strict: getting schema
    title: {
        type: String,
        required: true
    },
...
//         // even if id parameter is a null, the object is not going to be a null in database.
